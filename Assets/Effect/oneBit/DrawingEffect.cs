...
public class DrawingEffect : MonoBehaviour {
	...
	public OneBitEffectsDepthAndNormal.OverlayBlendMode blendMode2 = OneBitEffectsDepthAndNormal.OverlayBlendMode.Overlay;
	...
	void OnRenderImage(RenderTexture s, RenderTexture d){
		...
		RenderTexture rt3 = RenderTexture.GetTemporary(s.width, s.height);
		Graphics.Blit(rt1, rt3, effectOverlayMat, (int)blendMode);
		...
		Graphics.Blit(rt3, d, effectOverlayMat, (int)blendMode2);
